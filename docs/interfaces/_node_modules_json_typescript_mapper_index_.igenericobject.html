...
<head>
	...
	<title>IGenericObject | busybee</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_node_modules_json_typescript_mapper_index_.igenericobject.html">IGenericObject</a>
				</li>
			</ul>
			<h1>Interface IGenericObject</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>provide interface to indicate the object is allowed to be traversed</p>
					</div>
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">IGenericObject</span>
					</li>
				</ul>
			</section>
