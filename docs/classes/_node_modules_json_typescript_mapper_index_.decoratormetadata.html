...
<head>
	...
	<title>DecoratorMetaData | busybee</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html">DecoratorMetaData</a>
				</li>
			</ul>
			<h1>Class DecoratorMetaData&lt;T&gt;</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>DecoratorMetaData
						Model used for decoration parameters</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>class</dt>
						<dd></dd>
						<dt>property</dt>
						<dd><p>{string} name, indicate which json property needed to map</p>
						</dd>
						<dt>property</dt>
						<dd><p>{string} clazz, if the target is not primitive type, map it to corresponding class</p>
						</dd>
					</dl>
				</div>
			</section>
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">DecoratorMetaData</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external tsd-is-not-exported">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external tsd-is-not-exported"><a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#constructor" class="tsd-kind-icon">constructor</a></li>
							</ul>
						</section>
						<section class="tsd-index-section tsd-is-external tsd-is-not-exported">
							<h3>Properties</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external tsd-is-not-exported"><a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#clazz" class="tsd-kind-icon">clazz</a></li>
								<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external tsd-is-not-exported"><a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#name" class="tsd-kind-icon">name</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external tsd-is-not-exported">
				...
				<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external tsd-is-not-exported">
					...
					<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external tsd-is-not-exported">
						<li class="tsd-signature tsd-kind-icon">new <wbr>Decorator<wbr>Meta<wbr>Data<span class="tsd-signature-symbol">(</span>name<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span>, clazz<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html" class="tsd-signature-type">DecoratorMetaData</a></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/json-typescript-mapper/index.ts:54</li>
								</ul>
							</aside>
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5><span class="tsd-flag ts-flagOptional">Optional</span> clazz: <span class="tsd-signature-type">object</span></h5>
									<ul class="tsd-parameters">
										<li class="tsd-parameter">
											...
											<ul class="tsd-descriptions">
												<li class="tsd-description">
													<aside class="tsd-sources">
														<ul>
															<li>Defined in node_modules/json-typescript-mapper/index.ts:55</li>
														</ul>
													</aside>
							...
							<h4 class="tsd-returns-title">Returns <a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html" class="tsd-signature-type">DecoratorMetaData</a></h4>
						</li>
					</ul>
				</section>
			</section>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external tsd-is-not-exported">
						<a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html" class="tsd-kind-icon">Decorator<wbr>Meta<wbr>Data</a>
						<ul>
							<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external tsd-is-not-exported">
								<a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#constructor" class="tsd-kind-icon">constructor</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external tsd-is-not-exported">
								<a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#clazz" class="tsd-kind-icon">clazz</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external tsd-is-not-exported">
								<a href="_node_modules_json_typescript_mapper_index_.decoratormetadata.html#name" class="tsd-kind-icon">name</a>
							</li>
						</ul>
					</li>
				</ul>
