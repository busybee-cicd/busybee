      ...
      let ctrl = (req, res) => {
        ...
        */
        ...
        matchingMocks.forEach((m) => {
          ...
          this.logger.debug("reqHeaders");
          this.logger.debug(JSON.stringify(reqHeaders, null, '\t'));
          if (mockServerConf.injectedRequestOpts && mockServerConf.injectedRequestOpts.headers) {
            ...
            this.logger.debug("reqHeadersInjected");
            this.logger.debug(JSON.stringify(reqHeaders, null, '\t'));
          }
          ...
          this.logger.debug(JSON.stringify(mockHeaders, null, '\t'));
