...
var RESTSuiteManager = /** @class */ (function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            this.logger.trace(
              'runRESTApiTestSet ' + currentEnv.ports + ' ' + testSet.id
            );
          ...
          case 2:
            ...
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, promiseTools.series(testFns)];
          case 4:
            testResults = _a.sent();
            _a.label = 5;
          case 5:
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                this.logger.info(
                  testSet.id + ': ' + testIndex + ': ' + test.id
                );
                if (!test.delayRequest) return [3 /*break*/, 2];
                this.logger.info(
                  'Delaying request for ' +
                    test.delayRequest / 1000 +
                    ' second(s)'
                );
              ...
              case 3:
                ...
                return [
                  4 /*yield*/,
                  this.validateTestResult(
                    testSet,
                    test,
                    Object.assign(
                      {},
                      this.restClient.getDefaultRequestOpts(),
                      opts
                    ),
                    response
                  )
  ...
  RESTSuiteManager.prototype.makeRequestWithRetries = function(
    opts,
    retries,
    retryMax
  ) {
  ...
  /*
     ...
     */
  RESTSuiteManager.prototype.processRequestOptsForVariableDeclarations = function(
    opts,
    variableExports
  ) {
    var _this = this;
  ...
  RESTSuiteManager.prototype.replaceVarsInObject = function(
    obj,
    variableExports
  ) {
    var _this = this;
  ...
  RESTSuiteManager.prototype.validateTestResult = function(
    testSet,
    test,
    reqOpts,
    res
            ...
            if (test.expect.assertionModifications) {
              ...
              if (test.expect.assertionModifications.unorderedCollections) {
                ...
                /*
                                 ...
                                 */
                UnorderedCollections_1.UnorderedCollections.process(
